...
GraphNode::~GraphNode() { std::cout << "GraphNode Destructor" << std::endl; }
...
void GraphNode::AddEdgeToChildNode(std::unique_ptr<GraphEdge> edge) { _childEdges.push_back(std::move(edge)); }
